...
5. Lisää luokkaan: (h-tiedostoon)
   - public metodi void startToWait();
   - signals osioon signaali void readyToSay();
   - public slots osio ja siihen metodi void sayHelloSlot();
   - Lisää #include < QThread >
   - Lisää myös #include < QCoreApplication >, jos se puuttuu
